...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=b06ac3a0')
    .then(res => res.json())
...
async function removeFromfavorites(id) {
    ...
    window.location.replace('imdb_fav.html');
}
...
async function displayMovieList(movies) {
    ...
    for (i of movies) {
        ...
        <div class="fav-item">
            ...
            <a href="imdb_movie.html?id=${id}"><img src=${img} alt="Favourites Poster"></a>
            </div>
            <div class="fav-details">
                <div class="fav-details-box">
                    <div>
                        <p class="fav-movie-name"><a href="imdb_movie.html?id=${id}">${i.Title}</a></p>
                        <p class="fav-movie-rating"><a href="imdb_movie.html?id=${id}">${i.Year}</a></p>
                    </div>
                    <div>
